  ...
  void DFS(int u)
  {
    ...
    while (begin != end) {
      ...
      if (!visited[*begin]) {
        ...
        // Ako smo naisli na neposecenog suseda, znaci da je broj potomaka cvora v treba da se poveca za 1
        children++;

        // Ako imamo suseda za cvor u ciji je lower time tj. lower_times[*begin] manji od lower time-a trenutnog cvora onda azuriramo i lower time trenutnog cvora
...
private:
  ...
  // Vektor koji cuva lower times za sve cvorove. Lower time je zapravo minmalna vrednost time-a za sve susedne cvorove cvora u
