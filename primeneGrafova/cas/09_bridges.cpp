  ...
  void DFS(int u)
  {
    ...
    while (begin != end) {
      ...
      if (!visited[*begin]) {
        ...
        // Ako je vreme tenutnog cvora manje od najranijeg trenutka kada sused *begin moze biti posecen, znaci da je jedini put do *begin preko u. Ako uklonimo tu granu\
        // graf postaje nepovezan, pa je ona most
